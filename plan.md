...
| Test status | Full `./mvnw.cmd test` passed 338 tests on 2026-06-24; targeted `AdminFlowIntegrationTests,AdminTripServiceTests` passed 4 tests on 2026-06-25; backend CI workflow added locally, awaiting first GitHub run |
