...
public enum ErrorCode {
    ...
    SERVICE_AREA_NOT_FOUND(HttpStatus.NOT_FOUND, "Service area not found"),
    ...
    WORD_LOCATION_INVALID_ADDRESS(HttpStatus.BAD_REQUEST, "Three-word address is invalid"),
    WORD_LOCATION_NOT_FOUND(HttpStatus.NOT_FOUND, "Three-word address was not found"),
    WORD_LOCATION_OUT_OF_BOUNDS(HttpStatus.UNPROCESSABLE_ENTITY, "Coordinates are outside the supported three-word map"),
    WORD_LOCATION_PROVIDER_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "Three-word location provider is unavailable"),
    WORD_LOCATION_PROVIDER_ERROR(HttpStatus.BAD_GATEWAY, "Three-word location provider request failed"),
    ...
    ANALYTICS_RUN_NOT_FOUND(HttpStatus.NOT_FOUND, "Analytics processing run was not found"),
